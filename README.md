...
### Find Harbor URI
~~~
[root@rk9-node01 ~]# nslookup harbor.jtest.suse.com
Server:         192.168.0.90
Address:        192.168.0.90#53

Name:   harbor.jtest.suse.com
Address: 192.168.1.249
~~~

### Login into Harbor Registry
~~~
[root@rk9-node01 ~]# docker login https://harbor.jtest.suse.com
...
### Tag Ubuntu Image
~~~
[root@rk9-node01 ~]# docker tag ubuntu:22.04 harbor.jtest.suse.com/library/ubuntu:22.04
~~~

### Push Ubuntu Image
~~~
[root@rk9-node01 ~]# docker push harbor.jtest.suse.com/library/ubuntu:22.04
The push refers to repository [harbor.jtest.suse.com/library/ubuntu]
931b7ff0cb6f: Pushed
